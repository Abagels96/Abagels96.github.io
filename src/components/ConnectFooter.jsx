...
function LinkedInIcon() {
  return (
    <svg className="social-btn__icon" viewBox="0 0 24 24" width={20} height={20} aria-hidden="true">
      <path
        fill="currentColor"
...
export function ConnectFooter({ name, contact: contactCopy, social }) {
  return (
            ...
            <div className="contact__intro">
              <div className="section__intro-stack">
                ...
                <Reveal variant="rise" delay={50}>
                  <h2 id="contact-heading" className="section__title section__title--contact">
                    {contactCopy.title}
                  </h2>
                </Reveal>
                <Reveal variant="fade" delay={110}>
                  <p className="contact__lead">{contactCopy.lead}</p>
                </Reveal>
              </div>
            </div>
            <Reveal delay={100}>
